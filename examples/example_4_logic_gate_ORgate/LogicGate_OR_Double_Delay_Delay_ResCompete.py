...
def model_LogicGate_OR_Double_Delay_Delay_ResCompete(y, t, params):
	...
	dPep3_dt  = (syn_Pep*(1-state1*state2*Ratio)*mRNA3)-(deg_Pep*Pep3)

	return np.array([dInde1_dt, dIndi1_dt, dInde2_dt, dIndi2_dt, dmRNA1_dt, dPep1_dt, dmRNA2_dt, dPep2_dt, dmRNA3_dt, dPep3_dt])