...
if __name__ == '__main__':
    ...
    models, params, config_data = sm.get_models_and_params(model_files[4], user_core_models=user_core_models)
    ...
    The steps are as follows:
        ...
        2. read core model
        3. get strike-goldd args from config file for settings and user_core_models
        4. run strike-goldd analyze function
