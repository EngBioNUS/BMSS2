    ...
    *model*, the
    ...
    def __init__(self, time_units='second', extent_units='mole', \
        ...
        if (sbmlFile == None) and (sbmlStr == None): # They want to create a new model
            ...
            self._check(per_min,                          'create unit definition')
            self._check(per_min.setId('per_min'),      'set unit definition id')
            unit = per_min.createUnit()
            self._check(unit,                               'create unit on per_min')
            self._check(unit.setKind(libsbml.UNIT_KIND_SECOND),     'set unit kind')
            self._check(unit.setExponent(-1),               'set unit exponent')
            self._check(unit.setScale(0),                   'set unit scale')
            self._check(unit.setMultiplier(60),              'set unit multiplier')
            
            minute = self.model.createUnitDefinition()
            self._check(minute,                         'create unit definition')
            self._check(minute.setId('minute'),     'set unit definition id')
            ...
            seconds = self.model.createUnitDefinition()
            self._check(seconds,                         'create unit definition')
            self._check(seconds.setId('seconds'),     'set unit definition id')
            unit = seconds.createUnit()
            self._check(unit,                               'create unit')
            self._check(unit.setKind(libsbml.UNIT_KIND_SECOND),     'set unit kind')
            self._check(unit.setExponent(1),               'set unit exponent')
            self._check(unit.setScale(0),                   'set unit scale')
            ...
            self._check(molperLmin,                         'create unit definition')
            self._check(molperLmin.setId('molperLmin'),     'set unit definition id')
            unit = molperLmin.createUnit()
            self._check(unit,                               'create unit on per_second')
            self._check(unit.setKind(libsbml.UNIT_KIND_MOLE),     'set unit kind')
            self._check(unit.setExponent(1),               'set unit exponent')
            self._check(unit.setScale(0),                   'set unit scale')
            self._check(unit.setMultiplier(1),              'set unit multiplier')
            unit = molperLmin.createUnit()
            self._check(unit,                               'create unit on per_second')
            self._check(unit.setKind(libsbml.UNIT_KIND_LITRE),     'set unit kind')
            self._check(unit.setExponent(-1),               'set unit exponent')
            self._check(unit.setScale(0),                   'set unit scale')
            self._check(unit.setMultiplier(1),              'set unit multiplier')
            unit = molperLmin.createUnit()
            ...
            molpermin = self.model.createUnitDefinition()
            self._check(molpermin,                         'create unit definition')
            self._check(molpermin.setId('molpermin'),     'set unit definition id')
            unit = molpermin.createUnit()
            self._check(unit,                               'create unit on per_second')
            self._check(unit.setKind(libsbml.UNIT_KIND_MOLE),     'set unit kind')
            self._check(unit.setExponent(1),               'set unit exponent')
            self._check(unit.setScale(0),                   'set unit scale')
            ...
            self._check(molperL,                         'create unit definition')
            self._check(molperL.setId('molperL'),     'set unit definition id')
            ...
            mol = self.model.createUnitDefinition()
            self._check(mol,                         'create unit definition')
            self._check(mol.setId('mol'),     'set unit definition id')
            unit = mol.createUnit()
            self._check(unit,                               'create unit')
            self._check(unit.setKind(libsbml.UNIT_KIND_MOLE),     'set unit kind')
            self._check(unit.setExponent(1),               'set unit exponent')
            ...
            self._check(Dimension_less,                         'create unit definition')
            self._check(Dimension_less.setId('Dimension_less'),     'set unit definition id')
            ...
            self._check(items.setId('items'),     'set unit definition id')
            unit = items.createUnit()
            self._check(unit,                               'create unit')
            self._check(unit.setKind(libsbml.UNIT_KIND_ITEM),     'set unit kind')
            self._check(unit.setExponent(1),               'set unit exponent')
            self._check(unit.setScale(0),                   'set unit scale')
            self._check(unit.setMultiplier(1),              'set unit multiplier')
            
            itemspermol = self.model.createUnitDefinition()
            self._check(itemspermol,                         'create unit definition')
            self._check(itemspermol.setId('itemspermol'),     'set unit definition id')
            unit = itemspermol.createUnit()
            self._check(unit,                               'create unit')
            self._check(unit.setKind(libsbml.UNIT_KIND_ITEM),     'set unit kind')
            self._check(unit.setExponent(1),               'set unit exponent')
            self._check(unit.setScale(0),                   'set unit scale')
